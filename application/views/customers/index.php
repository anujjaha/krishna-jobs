					...
					<td>
						<span id="userStatus_<?php echo $customer['id'];?>">
							...
							if($customer['status'] == 1)
								echo "<a class='green' href='javascript:void(0);'
									onclick='changeUserStatus(".$customer['id'].",0)'>
									Active</a>";
							else
								echo "<a class='red' href='javascript:void(0);'
									onclick='changeUserStatus(".$customer['id'].",1)'>
									Inactive</a>";
							?> 	
						</span>		
					</td>
